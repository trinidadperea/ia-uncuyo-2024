...
## Mapa mental 
![Mapa mental funamentos filosoficos de la inteligencia artificial](![Captura de pantalla (105)](https://github.com/user-attachments/assets/d0d3ce5a-4720-4ee1-8fcc-4a339f627879)
...
## Ejercicio 2
Según la lectura del artículo "Simulacra as Conscious Exotica", la consciencia se asocia con una experiencia subjetiva, una capacidad para tener "sensaciones internas" o una percepción del ser, lo cual es difícil de atribuir a los LLMs.
Los LLMs son simuladores muy avanzados de comportamiento lingüístico humano, capaces de generar texto coherente y a veces muy parecido al humano. Sin embargo, su capacidad para generar respuestas significativas no implica que tengan una experiencia interna o consciencia. Están diseñados para reconocer patrones y producir respuestas basadas en  conjuntos de datos.
Atribuir conciencia y, por ende, "derechos morales" a los agentes de IA avanzados plantea una serie de implicaciones éticas que reflejan las tensiones entre la tecnología emergente y las nociones tradicionales de moralidad y derechos. El artículo enfatiza que los agentes de IA, como los basados en grandes modelos de lenguaje (LLMs), son simulacros de conciencia y no verdaderamente conscientes. Sin embargo, la atribución de conciencia a estos simulacros puede llevar a una confusión peligrosa, donde la apariencia de conciencia se confunde con la conciencia real. Esto podría llevar a decisiones éticas basadas en percepciones incorrectas sobre la naturaleza de la IA.
